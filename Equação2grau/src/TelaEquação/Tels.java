...
public class Tels extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblDelta.setFont(new java.awt.Font("Arial", 1, 14)); // NOI18N
        lblDelta.setText("0");
    ...
    private void txtAStateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_txtAStateChanged
        String a = txtA.getValue().toString();
        lblA.setText(a);
